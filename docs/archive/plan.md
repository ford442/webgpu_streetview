...
> **Archived / stale.** Pointer: [`docs/plan.md`](../plan.md). Shipped work is documented in [`AGENTS.md`](../../AGENTS.md). For active residual items see [`weekly_plan.md`](../../weekly_plan.md). Do not treat unchecked boxes below as current backlog.
