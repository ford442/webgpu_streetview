...
/** 2-D Perlin gradient noise [-1, 1]. Matches ABI export: 'noise2d'. */
EMSCRIPTEN_KEEPALIVE
...
/** fBm over noise2d, normalised to [-1, 1]. Matches ABI export: 'fbm2d'. */
EMSCRIPTEN_KEEPALIVE
 ...
 * Matches ABI export: 'fill_fbm_buffer'.
 */
EMSCRIPTEN_KEEPALIVE
 ...
 * Matches ABI export: 'fill_particle_seeds'.
 */
EMSCRIPTEN_KEEPALIVE
...
/** Haversine great-circle distance in metres. Matches ABI export: 'haversine'. */
EMSCRIPTEN_KEEPALIVE
 ...
 * Matches ABI export: 'batch_haversine'.
 */
EMSCRIPTEN_KEEPALIVE
...
/** Smallest signed angle difference [-180, 180). Matches ABI export: 'signed_angle_diff'. */
EMSCRIPTEN_KEEPALIVE
