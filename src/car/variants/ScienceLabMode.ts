...
import { ScienceLabAudio } from './scienceLab/scienceLabAudio';
import {
    buildLabInterior,
    createScienceLabLighting,
    type ScienceLabGeometryContext,
} from './scienceLab/scienceLabGeometry';
import { createScienceLabMaterials, type ScienceLabMaterials } from './scienceLab/scienceLabMaterials';
