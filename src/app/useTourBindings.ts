...
export function useTourBindings({
  ...
  const tourPanelProps: TourPanelBindings = useMemo(
    ...
    [
      toursApi.tours,
      toursApi.isRecording,
      toursApi.isPaused,
      toursApi.draftWaypoints,
      toursApi.startRecording,
      toursApi.pauseRecording,
      toursApi.resumeRecording,
      toursApi.stopRecording,
      toursApi.cancelRecording,
      toursApi.addWaypointFromCurrent,
      toursApi.deleteTour,
      toursApi.renameTour,
      toursApi.updateTourSettings,
      toursApi.downloadTourJson,
      toursApi.downloadTourKml,
      toursApi.importTourFromJson,
      getCurrentPOV,
      locationName,
      teleportToPanoSafe,
      setHeading,
